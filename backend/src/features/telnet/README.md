...
| LINEMODE                                  | Full           | WILL               | DO                 | Client negotiates LINEMODE with MODE (EDIT/TRAPSIG/SOFT_TAB), acknowledges SLC changes, and publishes a CR/LF forward mask so lines flush only on Enter.                                                                           | https://github.com/unitopia-de/webmud3/issues/114 |
