...
// docker run --volume /UNItopia/ftpwww/webmud3/run/dbs/:/run/dbs -it myonara/webmud3:unitopiatest node /app/data_access/sqlite_bootstrap.js
...
const creation = 'DROP TABLE IF EXISTS debugaddittionals;DROP TABLE IF EXISTS debuglog;'+
                 'CTABLE debuglog(id BIGINT primary key, ts VARCHAR(20), '+
