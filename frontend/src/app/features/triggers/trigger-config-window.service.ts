...
const MENU_ID = 'trigger-config-window';
const GEOMETRY_KEY = 'trigger-config-window';
...
/**
 * Opens / closes the trigger configuration window and keeps the matching
 * footer menu entry in sync. Mirrors the pattern used by
 * `InventoryWindowService`.
 */
@Injectable({ providedIn: 'root' })
export class TriggerConfigWindowService {
